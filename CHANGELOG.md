...
- **Next.js server errors** — `@telemetry-tracker/next/server` `createOnRequestError` reports uncaught App Router server errors (Node and Edge). Browser 1.3.1 is unchanged until 1.3.2 is published
